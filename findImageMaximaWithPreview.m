...
% <goldschen-ohm@utexas.edu, marcel.goldschen@gmail.com>
    ...
    if ~exist('uiImagePreviewHandle', 'var') || ~isvalid(uiImagePreviewHandle)
        tempFig = figure('Name', 'Find Image Maxima', ...
            'numbertitle', 'off', ...
            'Units', 'normalized', ...
            'Position', [0 0 1 1]);
        ax = axes(tempFig, ...
        ...
        ax = uiImagePreviewHandle.Parent;
    end
    hold(ax, 'on');
    uiMaximaPreviewHandle = scatter(ax, nan, nan, 'r+', ...
        'HitTest', 'off', ...
        'PickableParts', 'none');
